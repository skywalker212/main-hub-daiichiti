...
userlevels={ [-1] = 1, [0] = 6, [1] = 5, [2] = 4, [3] = 3, [4] = 2}
...
function OnStartup()
  ...
  for a,b in pairs(Types) do -- Add categories to rightclick. This is impossible on-the-fly.
    rightclick[{Levels.Add,"1 3","Releases/Requests\\Releases\\Add an item to the\\"..b,"!"..Commands.Add.." "..a.." %[line:Name:]"}]=0
    rightclick[{Levels.Show,"1 3","Releases/Requests\\Releases\\Show items of type\\"..b.."\\All","!"..Commands.Show.." "..a}]=0
    rightclick[{Levels.Show,"1 3","Releases/Requests\\Show items of type\\"..b.."\\Latest...","!"..Commands.Show.." "..a.." %[line:Number of items to show:]"}]=0
  end
...
function UserConnected(user)
  if  Core.GetUserValue(user, 12) then -- if login is successful, and usercommands can be sent
    ...
    --Core.SendToUser(user,"<»RachelGreen«>\t Releases have been successfully loaded by "..Bot.version)
  end
  if #AllStuff > 0 then
...
rightclick[{Levels.ShowCtgrs,"1 3","Releases/Requests\\Releases\\Show categories","!"..Commands.ShowCtgrs}]=0
rightclick[{Levels.Delete,"1 3","Releases/Requests\\Releases\\Delete a release","!"..Commands.Delete.." %[line:ID number(s):]"}]=0
rightclick[{Levels.ReLoad,"1 3","Releases/Requests\\Releases\\Reload releases database","!"..Commands.ReLoad}]=0
rightclick[{Levels.Search,"1 3","Releases/Requests\\Releases\\Search among releases","!"..Commands.Search.." %[line:Search string:]"}]=0
rightclick[{Levels.AddCatgry,"1 3","Releases/Requests\\Releases\\Add a category","!"..Commands.AddCatgry.." %[line:Category name:] %[line:Displayed name:]"}]=0
rightclick[{Levels.DelCatgry,"1 3","Releases/Requests\\Releases\\Delete a category","!"..Commands.DelCatgry.." %[line:Category name:]"}]=0
rightclick[{Levels.Help,"1 3","Releases/Requests\\Releases\\Help","!"..Commands.Help}]=0
rightclick[{Levels.Show,"1 3","Releases/Requests\\Releases\\Show all items","!"..Commands.Show}]=0
rightclick[{Levels.Show,"1 3","Releases/Requests\\Releases\\Show last "..MaxNew.." items","!"..Commands.Show.." new"}]=0
rightclick[{Levels.Show,"1 3","Releases/Requests\\Releases\\Show items in a certain range","!"..Commands.Show.." %[line:Start ID:]-%[line:End ID:]"}]=0
